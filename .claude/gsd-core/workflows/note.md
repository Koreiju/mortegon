...
- **Global scope**: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/isaac/Documents/web_fiber_haptics/.claude/notes/`)
...
2. Glob `C:/Users/isaac/Documents/web_fiber_haptics/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/isaac/Documents/web_fiber_haptics/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/isaac/Documents/web_fiber_haptics/.claude/notes/` — works in any directory
