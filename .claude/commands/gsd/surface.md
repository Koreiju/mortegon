...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/Users/isaac/Documents/web_fiber_haptics/.claude/.gsd-surface.json`
(sibling to `C:/Users/isaac/Documents/web_fiber_haptics/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/Users/isaac/Documents/web_fiber_haptics/.claude/skills/gsd-*/`.
...
(`C:/Users/isaac/Documents/web_fiber_haptics/.claude`), NOT the skills sub-directory (`C:/Users/isaac/Documents/web_fiber_haptics/.claude/skills`).

This matches `installRuntimeArtifacts` and `uninstallRuntimeArtifacts`, which also
receive `C:/Users/isaac/Documents/web_fiber_haptics/.claude` as `configDir`. The skill dirs themselves live at
`C:/Users/isaac/Documents/web_fiber_haptics/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
'skills'` — they are derived from `configDir`, not the root for it.

```bash
# Claude Code — global install
RUNTIME_CONFIG_DIR="${CLAUDE_CONFIG_DIR:-C:/Users/isaac/Documents/web_fiber_haptics/.claude}"
SCOPE="global"
...
(i.e. `C:/Users/isaac/Documents/web_fiber_haptics/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/.gsd-surface.json`
Install profile marker: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/.gsd-profile`
Skill dirs: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/skills/gsd-*/`
Engine module: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/Users/isaac/Documents/web_fiber_haptics/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
