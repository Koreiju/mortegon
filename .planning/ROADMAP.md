...
- [x] 08-03-PLAN.md — STEP-01 stepper (backend signal-cursor chunk-id resolution + `projector.flyToNode`/`highlightNode` + `fe/stepper.mjs`; one-way 2D→3D)
...
| 8. Halo Cone-Ray + Brace + Stepper | v3.0 | 3/4 | In Progress|  |
