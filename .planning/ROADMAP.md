...
**Success Criteria** (what must be TRUE):
  ...
  4. Pinned panels draw a solid headless arrow to their `data-3d-node-id` that tracks the moving node; `black_slate.spec` (no dotted overlays) stays green + a new arrow-tracking e2e.**Plans**: 2/4 plans executed
...
| 6. 3D Real Register (served) | v3.0 | 2/4 | In Progress|  |
