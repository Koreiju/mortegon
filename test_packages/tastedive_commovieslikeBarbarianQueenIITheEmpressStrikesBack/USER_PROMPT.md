# Test Generation Task: tastedive_commovieslikeBarbarianQueenIITheEmpressStrikesBack.html
...
**Structural chunks:**
  - Chunk 0: `a.details.entity` (freq=35, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `button.button.jq` (freq=852, pq_sig=`button(div(svg(path)),span,span)`)
  - Chunk 2: `div.sc.slrv` (freq=13, pq_sig=`div(div(img))`)
  - Chunk 3: `div.sc.slrv` (freq=8, pq_sig=`div(div(div(img)))`)
...
**Text/Nav chunks:**
  ...
  - Chunk 19: `[nav_content:a×142]` (freq=142)
...
```
=== QUALITY REPORT: tastedive_commovieslikeBarbarianQueenIITheEmpressStrikesBack.html ===
Chunks: 177 (structural=4, functional=4, text=169)
Categories: {'card': 3, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 169, 'menu_item': 2}
Content: 215 tagged, 215 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.details.entity ---
  type=card freq=35 excl=0.00
  pattern_xpath: ///a
...
--- Chunk 1: button.button.jq ---
  type=button freq=852 excl=1.00
...
--- Chunk 5: [pagination_buttons] ---
  type=pagination freq=54 excl=0.00
...
--- Chunk 19: [nav_content:a×142] ---
  type=menu_item freq=142 excl=0.00
  pattern_xpath: ///a
  content: [ATTR=9 HREF=1 IMG=6 TEXT=2]
...
4. Use filename `tastedive_commovieslikeBarbarianQueenIITheEmpressStrikesBack.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeBarbarianQueenIITheEmpressStrikesBack_gen.py`
