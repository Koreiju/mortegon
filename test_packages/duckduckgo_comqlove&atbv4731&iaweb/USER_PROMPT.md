# Test Generation Task: duckduckgo_comqlove&atbv4731&iaweb.html
...
**Text/Nav chunks:**
  ...
  - Chunk 13: `[text_content:li×3]` (freq=3)
  - Chunk 14: `[text_content:li×6]` (freq=6)
  - Chunk 15: `[text_content:li×3]` (freq=3)
  ...
  - Chunk 20: `[nav_content:a×31]` (freq=31)
  - Chunk 21: `[nav_content:li×4]` (freq=4)
  - Chunk 22: `[nav_content:li×10]` (freq=10)
  - Chunk 23: `[nav_content:li×20]` (freq=20)
...
```
=== QUALITY REPORT: duckduckgo_comqlove&atbv4731&iaweb.html ===
...
Content: 783 tagged, 610 preserved (78%)
Leaks: 173 total, 68 high-importance
...
--- Chunk 12: [text_content:li×2] ---
  type=text_singleton freq=2 excl=0.70
  pattern_xpath: ///li[contains(@data-layout,'about')][contains(@data-layout,'related')][contains(@data-layout,'searches')][contains(@class,'ca')][contains(@class,'fj')]
  content: [ATTR=2 HREF=3 TEXT=10]

--- Chunk 13: [text_content:li×3] ---
...
--- Chunk 14: [text_content:li×6] ---
  type=text_singleton freq=6 excl=0.28
  pattern_xpath: ///li[contains(@class,'definition')][contains(@class,'definitions')][contains(@class,'module')]
  content: [TEXT=1]

--- Chunk 15: [text_content:li×3] ---
  type=text_singleton freq=3 excl=0.28
...
4. Use filename `duckduckgo_comqlove&atbv4731&iaweb.html` in all `_distill()` calls
5. Name the module `test_duckduckgo_comqlove&atbv4731&iaweb_gen.py`
