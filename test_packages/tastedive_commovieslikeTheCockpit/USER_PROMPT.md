# Test Generation Task: tastedive_commovieslikeTheCockpit.html
...
**Structural chunks:**
  - Chunk 0: `a.details.entity` (freq=57, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `button.button.jq` (freq=930, pq_sig=`button(div(svg(path)),span,span)`)
  - Chunk 2: `div.sc.slrv` (freq=22, pq_sig=`div(div(img))`)
  - Chunk 3: `div.sc.slrv` (freq=8, pq_sig=`div(div(div(img)))`)

**Text/Nav chunks:**
  - Chunk 6: `[text_content:p×2]` (freq=1)
  - Chunk 7: `[text_content:p×2]` (freq=2)
  - Chunk 8: `[text_content:p×6]` (freq=6)
  - Chunk 9: `[text_content:p×2]` (freq=2)
  - Chunk 10: `[text_content:p×2]` (freq=2)
  - Chunk 11: `[text_content:p×8]` (freq=8)
  ...
  - Chunk 19: `[nav_content:a×155]` (freq=155)
...
```
=== QUALITY REPORT: tastedive_commovieslikeTheCockpit.html ===
Chunks: 188 (structural=4, functional=4, text=180)
Categories: {'card': 3, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 180, 'menu_item': 2}
Content: 230 tagged, 230 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.details.entity ---
  type=card freq=57 excl=0.00
  pattern_xpath: ///a
...
--- Chunk 1: button.button.jq ---
  type=button freq=930 excl=1.00
...
--- Chunk 5: [pagination_buttons] ---
  type=pagination freq=47 excl=0.00
...
--- Chunk 11: [text_content:p×8] ---
  type=text_singleton freq=8 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]
...
--- Chunk 19: [nav_content:a×155] ---
  type=menu_item freq=155 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeTheCockpit.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeTheCockpit_gen.py`
