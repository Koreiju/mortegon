# Test Generation Task: tastedive_commovieslikeHeartStringMarionette2012.html
...
**Structural chunks:**
  - Chunk 0: `a.ab.details` (freq=50, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `a.details.entity` (freq=34, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 2: `div.icon.kswo` (freq=930, pq_sig=`div(svg(path))`)
  - Chunk 3: `div.sc.slrv` (freq=31, pq_sig=`div(div(img))`)
  - Chunk 4: `div.sc.slrv` (freq=6, pq_sig=`div(div(div(img)))`)
...
**Text/Nav chunks:**
  ...
  - Chunk 18: `[nav_content:a×10]` (freq=10)
  - Chunk 19: `[nav_content:a×154]` (freq=154)
...
```
=== QUALITY REPORT: tastedive_commovieslikeHeartStringMarionette2012.html ===
Chunks: 193 (structural=5, functional=4, text=184)
Categories: {'card': 5, 'search_input': 1, 'pagination': 1, 'text_singleton': 184, 'menu_item': 2}
Content: 244 tagged, 244 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.ab.details ---
  type=card freq=50 excl=0.00
  pattern_xpath: ///a
...
--- Chunk 6: [pagination_buttons] ---
  type=pagination freq=51 excl=0.00
...
--- Chunk 19: [nav_content:a×154] ---
  type=menu_item freq=154 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeHeartStringMarionette2012.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeHeartStringMarionette2012_gen.py`
