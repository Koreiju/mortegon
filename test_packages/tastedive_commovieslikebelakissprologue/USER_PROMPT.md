# Test Generation Task: tastedive_commovieslikebelakissprologue.html
...
**Structural chunks:**
  - Chunk 0: `a.details.entity` (freq=62, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `a.details.entity` (freq=38, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 2: `button.button.jq` (freq=954, pq_sig=`button(div(svg(path)),span,span)`)

**Text/Nav chunks:**
  - Chunk 5: `[text_content:p×2]` (freq=1)
  - Chunk 6: `[text_content:p×2]` (freq=2)
  - Chunk 7: `[text_content:p×2]` (freq=2)
  - Chunk 8: `[text_content:p×4]` (freq=4)
  ...
  - Chunk 19: `[nav_content:a×10]` (freq=10)
  - Chunk 20: `[nav_content:a×157]` (freq=157)
...
```
=== QUALITY REPORT: tastedive_commovieslikebelakissprologue.html ===
Chunks: 193 (structural=3, functional=4, text=186)
Categories: {'card': 2, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 186, 'menu_item': 2}
Content: 241 tagged, 241 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.details.entity ---
  type=card freq=62 excl=0.00
  pattern_xpath: ///a
...
--- Chunk 2: button.button.jq ---
  type=button freq=954 excl=1.00
...
--- Chunk 20: [nav_content:a×157] ---
  type=menu_item freq=157 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikebelakissprologue.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikebelakissprologue_gen.py`
