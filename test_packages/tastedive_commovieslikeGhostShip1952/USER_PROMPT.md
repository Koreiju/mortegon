# Test Generation Task: tastedive_commovieslikeGhostShip1952.html
...
**Structural chunks:**
  - Chunk 0: `a.details.entity` (freq=52, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `a.details.entity` (freq=28, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 2: `button.button.jq` (freq=912, pq_sig=`button(div(svg(path)),span,span)`)
...
**Text/Nav chunks:**
  ...
  - Chunk 20: `[text_content:p×3]` (freq=3)
  - Chunk 21: `[nav_content:a×10]` (freq=10)
  - Chunk 22: `[nav_content:a×151]` (freq=151)
...
```
=== QUALITY REPORT: tastedive_commovieslikeGhostShip1952.html ===
Chunks: 189 (structural=3, functional=4, text=182)
Categories: {'card': 2, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 182, 'menu_item': 2}
Content: 237 tagged, 237 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.details.entity ---
  type=card freq=52 excl=0.00
  pattern_xpath: ///a
...
--- Chunk 2: button.button.jq ---
  type=button freq=912 excl=1.00
...
--- Chunk 4: [pagination_buttons] ---
  type=pagination freq=45 excl=0.00
...
--- Chunk 22: [nav_content:a×151] ---
  type=menu_item freq=151 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeGhostShip1952.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeGhostShip1952_gen.py`
