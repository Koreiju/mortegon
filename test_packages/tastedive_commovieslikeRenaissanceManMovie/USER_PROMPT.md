# Test Generation Task: tastedive_commovieslikeRenaissanceManMovie.html
...
**Structural chunks:**
  - Chunk 0: `div.icon.kswo` (freq=958, pq_sig=`div(svg(path))`)
  - Chunk 1: `div.ds.ff` (freq=69, pq_sig=`div(div(img))`)
  - Chunk 2: `div.ff.hiz` (freq=18, pq_sig=`div(button(img))`)
  - Chunk 3: `div.da.rwrhy` (freq=10, pq_sig=`div(div(img),div(img),div(img))`)
...
**Text/Nav chunks:**
  ...
  - Chunk 10: `[text_content:p×4]` (freq=4)
  - Chunk 11: `[text_content:p×2]` (freq=2)
  - Chunk 12: `[text_content:p×3]` (freq=3)
  - Chunk 13: `[text_content:p×3]` (freq=3)
  - Chunk 14: `[text_content:p×6]` (freq=6)
  - Chunk 15: `[text_content:p×3]` (freq=3)
  - Chunk 16: `[nav_content:a×10]` (freq=10)
  - Chunk 17: `[nav_content:a×18]` (freq=18)
  - Chunk 18: `[nav_content:a×148]` (freq=148)
...
```
=== QUALITY REPORT: tastedive_commovieslikeRenaissanceManMovie.html ===
Chunks: 191 (structural=4, functional=5, text=182)
Categories: {'card': 3, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 182, 'menu_item': 3}
Content: 245 tagged, 239 preserved (98%)
Leaks: 6 total, 6 high-importance

--- Chunk 0: div.icon.kswo ---
  type=card freq=958 excl=0.80
...
--- Chunk 1: div.ds.ff ---
  type=card freq=69 excl=0.17
  pattern_xpath: ///div[contains(@class,'ff')][contains(@class,'sc')]
  tree_sig: div(div(img))
  content: [ATTR=1 IMG=3]

--- Chunk 2: div.ff.hiz ---
  type=button freq=18 excl=0.58
...
--- Chunk 3: div.da.rwrhy ---
  type=card freq=10 excl=0.67 LEAKS=6
  ...
  LEAKS (high):
    [IMG] https://images.qloo.com/i/7b22d01a-b908-4465-a902-1b47204692ea-127x180-outside.webp (img URL not in rendered)
    [IMG] https://images.qloo.com/i/7b22d01a-b908-4465-a902-1b47204692ea-126x90-outside.webp (img URL not in rendered)
    [IMG] https://images.qloo.com/i/7b22d01a-b908-4465-a902-1b47204692ea-252x180-outside.webp (img URL not in rendered)
    [IMG] https://images.qloo.com/i/ac7f132e-b71e-4663-870c-ed7833514126-127x180-outside.webp (img URL not in rendered)
    [IMG] https://images.qloo.com/i/ac7f132e-b71e-4663-870c-ed7833514126-126x90-outside.webp (img URL not in rendered)
...
--- Chunk 5: [pagination_buttons] ---
  type=pagination freq=69 excl=0.00
...
--- Chunk 17: [nav_content:a×18] ---
  type=menu_item freq=18 excl=1.00
  pattern_xpath: ///a[contains(@class,'cn')][contains(@class,'de')][contains(@class,'ed')][contains(@class,'gn')][contains(@class,'ka')]
  content: [ATTR=6 HREF=1 IMG=4 TEXT=5]

--- Chunk 18: [nav_content:a×148] ---
  type=menu_item freq=148 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeRenaissanceManMovie.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeRenaissanceManMovie_gen.py`
