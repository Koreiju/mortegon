# Test Generation Task: tastedive_commovieslikeTonariNoYaeChan.html
...
**Structural chunks:**
  - Chunk 0: `a.details.entity` (freq=40, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 1: `a.details.entity` (freq=39, pq_sig=`div(meta,meta,meta,div(div(a(div(div(img)),div(div`)
  - Chunk 2: `button.button.jq` (freq=918, pq_sig=`button(div(svg(path)),span,span)`)
  - Chunk 3: `div.sc.slrv` (freq=17, pq_sig=`div(div(img))`)
  - Chunk 4: `div.sc.slrv` (freq=5, pq_sig=`div(div(div(img)))`)

**Text/Nav chunks:**
  - Chunk 7: `[text_content:p×2]` (freq=1)
  - Chunk 8: `[text_content:p×2]` (freq=2)
  - Chunk 9: `[text_content:p×2]` (freq=2)
  - Chunk 10: `[text_content:p×5]` (freq=5)
  - Chunk 21: `[text_content:p×6]` (freq=6)
  - Chunk 12: `[text_content:p×3]` (freq=3)
  - Chunk 13: `[text_content:p×3]` (freq=3)
  - Chunk 14: `[text_content:p×2]` (freq=2)
  - Chunk 15: `[text_content:p×7]` (freq=7)
  - Chunk 16: `[text_content:p×2]` (freq=2)
  - Chunk 17: `[text_content:p×3]` (freq=3)
  - Chunk 18: `[text_content:p×3]` (freq=3)
  - Chunk 19: `[text_content:p×4]` (freq=4)
  - Chunk 20: `[text_content:p×2]` (freq=2)
  - Chunk 21: `[text_content:p×6]` (freq=6)
  - Chunk 22: `[text_content:p×3]` (freq=3)
  - Chunk 23: `[text_content:p×3]` (freq=3)
  - Chunk 24: `[nav_content:a×10]` (freq=10)
  - Chunk 25: `[nav_content:a×153]` (freq=153)
...
```
=== QUALITY REPORT: tastedive_commovieslikeTonariNoYaeChan.html ===
Chunks: 195 (structural=5, functional=4, text=186)
Categories: {'card': 4, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 186, 'menu_item': 2}
Content: 247 tagged, 247 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: a.details.entity ---
  type=card freq=40 excl=0.00
  pattern_xpath: ///a
  tree_sig: div(meta,meta,meta,div(div(a(div(div(img)),div(div(div),div,h3,div)))))
  content: [ATTR=5 HREF=1 IMG=3 TEXT=3]

--- Chunk 1: a.details.entity ---
  type=card freq=39 excl=0.00
  pattern_xpath: ///a
  tree_sig: div(meta,meta,meta,div(div(a(div(div(img)),div(div(div),div,h3,div,div)))))
  content: [ATTR=5 HREF=1 IMG=3 TEXT=4]

--- Chunk 2: button.button.jq ---
  type=button freq=918 excl=0.90
...
--- Chunk 6: [pagination_buttons] ---
  type=pagination freq=48 excl=0.00
...
--- Chunk 10: [text_content:p×5] ---
  type=text_singleton freq=5 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]

--- Chunk 21: [text_content:p×6] ---
...
--- Chunk 18: [text_content:p×3] ---
  type=text_singleton freq=3 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]

--- Chunk 19: [text_content:p×4] ---
...
--- Chunk 22: [text_content:p×3] ---
  type=text_singleton freq=3 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]

--- Chunk 23: [text_content:p×3] ---
  type=text_singleton freq=3 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]

--- Chunk 24: [nav_content:a×10] ---
...
--- Chunk 25: [nav_content:a×153] ---
  type=menu_item freq=153 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeTonariNoYaeChan.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeTonariNoYaeChan_gen.py`
