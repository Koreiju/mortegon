# Test Generation Task: tastedive_commovieslikeBringingOutTheDeadMovie.html
...
**Structural chunks:**
  - Chunk 0: `div.icon.kswo` (freq=1032, pq_sig=`div(svg(path))`)
  - Chunk 1: `div.ff.hiz` (freq=24, pq_sig=`div(button(img))`)
  - Chunk 2: `div.ds.ff` (freq=91, pq_sig=`div(div(img))`)

**Text/Nav chunks:**
  - Chunk 5: `[text_content:p×2]` (freq=1)
  - Chunk 6: `[text_content:p×2]` (freq=2)
  ...
  - Chunk 19: `[text_content:p×3]` (freq=3)
  - Chunk 20: `[nav_content:a×10]` (freq=10)
  - Chunk 21: `[nav_content:a×24]` (freq=24)
  - Chunk 22: `[nav_content:a×156]` (freq=156)
...
```
=== QUALITY REPORT: tastedive_commovieslikeBringingOutTheDeadMovie.html ===
Chunks: 209 (structural=3, functional=5, text=201)
Categories: {'card': 2, 'button': 1, 'search_input': 1, 'pagination': 1, 'text_singleton': 201, 'menu_item': 3}
Content: 244 tagged, 244 preserved (100%)
Leaks: 0 total, 0 high-importance

--- Chunk 0: div.icon.kswo ---
  type=card freq=1032 excl=0.80
...
--- Chunk 4: [pagination_buttons] ---
  type=pagination freq=55 excl=0.00
...
--- Chunk 19: [text_content:p×3] ---
  type=text_singleton freq=3 excl=0.00
  pattern_xpath: ///p
  content: [TEXT=1]

--- Chunk 20: [nav_content:a×10] ---
...
--- Chunk 21: [nav_content:a×24] ---
  ...
  content: [ATTR=3 HREF=1 IMG=1 TEXT=5]

--- Chunk 22: [nav_content:a×156] ---
  type=menu_item freq=156 excl=0.00
  pattern_xpath: ///a
...
4. Use filename `tastedive_commovieslikeBringingOutTheDeadMovie.html` in all `_distill()` calls
5. Name the module `test_tastedive_commovieslikeBringingOutTheDeadMovie_gen.py`
